...
GdmAssistant.prototype.setup = function() {
	...
	this.controller.setupWidget("ImportGDList", {
		'itemTemplate': 'common/gdocs-item',
...
GdmAssistant.prototype.listGoogleShared = function(event) {
	...
	if(this.modelImportGDManual.value != "") {
		...
		new Ajax.Request("http://groups.google.com/group/score-tracker/feed/rss_v2_0_topics.xml?num=" + limit, {
				method: "get",
									...
									onChoose: function(value) {
										...
										this.controller.serviceRequest("palm://com.palm.applicationManager", {
											...
											recipients: [{
												type:"email",
												role:1,
												value:"score-tracker@googlegroups.com",
												contactDisplay:"Score Tracker Group"
											}]}}}); 
